...
- (void)getUserTimeLineUserID:(long long)userID withSinceID:(long long)sinceID maxiumumID:(long long)maxID statringAtPage:(int)page count:(int)count; // status/user_timeline
