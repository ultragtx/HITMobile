...
- (void)encodeWithCoder:(NSCoder *)encoder {
	[encoder encodeInt:userId forKey:[NSString stringWithFormat:@"User_userId_%d", encodeCount]];
	[encoder encodeObject:screenName forKey:[NSString stringWithFormat:@"User_screenName_%d", encodeCount]];
	[encoder encodeObject:description forKey:[NSString stringWithFormat:@"User_description_%d", encodeCount]];
	[encoder encodeObject:profileImageUrl forKey:[NSString stringWithFormat:@"User_profileImageUrl_%d", encodeCount]];
	[encoder encodeObject:profileLargeImageUrl forKey:[NSString stringWithFormat:@"User_profileLargeImageUrl_%d", encodeCount]];
	encodeCount++;
...
- (id)initWithCoder:(NSCoder *)decoder {
	if (self = [super init]) {
		self.userId = [decoder decodeIntForKey:[NSString stringWithFormat:@"User_userId_%d", decodeCount]];
		self.screenName = [decoder decodeObjectForKey:[NSString stringWithFormat:@"User_screenName_%d", decodeCount]];
		self.description = [decoder decodeObjectForKey:[NSString stringWithFormat:@"User_description_%d", decodeCount]];
		self.profileImageUrl = [decoder decodeObjectForKey:[NSString stringWithFormat:@"User_profileImageUrl_%d", decodeCount]];
		self.profileLargeImageUrl = [decoder decodeObjectForKey:[NSString stringWithFormat:@"User_profileLargeImageUrl_%d", decodeCount]];
		decodeCount++;
	}
	return self;
}
